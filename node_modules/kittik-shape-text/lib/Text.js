 ...
 * @extends {Shape}
 */
class Text extends _kittikShapeBasic2.default {
  /**
   * Create Text shape.
   *
   * @constructor
   ...
   */
  setDim() {
    let dim = arguments.length <= 0 || arguments[0] === undefined ? false : arguments[0];
   ...
   */
  setUnderlined() {
    let underlined = arguments.length <= 0 || arguments[0] === undefined ? false : arguments[0];
   ...
   */
  setBlink() {
    let blink = arguments.length <= 0 || arguments[0] === undefined ? false : arguments[0];
   ...
   */
  setReverse() {
    let reverse = arguments.length <= 0 || arguments[0] === undefined ? false : arguments[0];
   ...
   */
  setHidden() {
    let hidden = arguments.length <= 0 || arguments[0] === undefined ? false : arguments[0];
   ...
   */
  setAlign() {
    let align = arguments.length <= 0 || arguments[0] === undefined ? 'center' : arguments[0];
