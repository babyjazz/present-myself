...
class Cursor {
  ...
  constructor() {
    ...
    var _options$stream = options.stream;
    var stream = _options$stream === undefined ? process.stdout : _options$stream;
    var _options$width = options.width;
    var width = _options$width === undefined ? stream.columns : _options$width;
    var _options$height = options.height;
    var height = _options$height === undefined ? stream.rows : _options$height;
    ...
    this._cells = Array.from({ length: width * height }).map(() => new _Cell2.default());
  ...
  write(data) {
    ...
    for (var i = 0; i < data.length; i++) {
      ...
      if (0 <= x && x < width && 0 <= y && y < height) {
        this._cells[pointer].setChar(char).setX(x).setY(y).setBackground(background).setForeground(foreground).setDisplay(display.bold, display.dim, display.underlined, display.blink, display.reverse, display.hidden).setModified(true);
      }
   ...
   */
  getPointerFromXY() {
    let x = arguments.length <= 0 || arguments[0] === undefined ? this._x : arguments[0];
    let y = arguments.length <= 1 || arguments[1] === undefined ? this._y : arguments[1];
   ...
   */
  up() {
    let y = arguments.length <= 0 || arguments[0] === undefined ? 1 : arguments[0];
   ...
   */
  right() {
    let x = arguments.length <= 0 || arguments[0] === undefined ? 1 : arguments[0];
   ...
   */
  foreground() {
    let color = arguments.length <= 0 || arguments[0] === undefined ? 'none' : arguments[0];
   ...
   */
  bold() {
    let isBold = arguments.length <= 0 || arguments[0] === undefined ? true : arguments[0];
   ...
   */
  dim() {
    let isDim = arguments.length <= 0 || arguments[0] === undefined ? true : arguments[0];
   ...
   */
  underlined() {
    let isUnderlined = arguments.length <= 0 || arguments[0] === undefined ? true : arguments[0];
   ...
   */
  blink() {
    let isBlink = arguments.length <= 0 || arguments[0] === undefined ? true : arguments[0];
   ...
   */
  reverse() {
    let isReverse = arguments.length <= 0 || arguments[0] === undefined ? true : arguments[0];
   ...
   */
  hidden() {
    let isHidden = arguments.length <= 0 || arguments[0] === undefined ? true : arguments[0];
   ...
   */
  saveScreen() {
    this._stream.write((0, _encodeToVT.encodeToVT100)('[?47h'));
    return this;
  }
   ...
   */
  restoreScreen() {
    this._stream.write((0, _encodeToVT.encodeToVT100)('[?47l'));
    return this;
  }
   ...
   */
  hideCursor() {
    this._stream.write((0, _encodeToVT.encodeToVT100)('[?25l'));
    return this;
  }
   ...
   */
  showCursor() {
    this._stream.write((0, _encodeToVT.encodeToVT100)('[?25h'));
    return this;
  }
   ...
   */
  reset() {
    this._stream.write((0, _encodeToVT.encodeToVT100)('c'));
    return this;
  }
