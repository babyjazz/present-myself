...
class Shape {
   ...
   */
  setWidth() {
    let width = arguments.length <= 0 || arguments[0] === undefined ? 15 : arguments[0];
   ...
   */
  setHeight() {
    let height = arguments.length <= 0 || arguments[0] === undefined ? 5 : arguments[0];
   ...
   */
  setX() {
    let x = arguments.length <= 0 || arguments[0] === undefined ? 10 : arguments[0];
   ...
   */
  setY() {
    let y = arguments.length <= 0 || arguments[0] === undefined ? 10 : arguments[0];
   ...
   */
  setBackground() {
    let background = arguments.length <= 0 || arguments[0] === undefined ? 'none' : arguments[0];
   ...
   */
  setForeground() {
    let foreground = arguments.length <= 0 || arguments[0] === undefined ? 'none' : arguments[0];
